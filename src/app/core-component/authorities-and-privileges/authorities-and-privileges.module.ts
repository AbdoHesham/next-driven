...
import { AuthoritiesAndPrivilegesRoutingModule } from './authorities-and-privileges-routing.module';
...
@NgModule({
  declarations: [
    CreateEditAuthoritiesAndPrivilegesComponent,
    ListComponent,
    DetailsComponent,
  ...
  imports: [
    CommonModule,
    AuthoritiesAndPrivilegesRoutingModule,
...
export class AuthoritiesAndPrivilegesModule { }
